...
bash <(curl -s https://codecov.io/bash) -R ${SUPERDIR}/${MY_MODULE} -s ${DUNE_BUILD_DIR}/${MY_MODULE} -Z -K -v \
  -X gcov -X coveragepy -F ctest -f ${COVERAGE_INFO} -t ${CODECOV_TOKEN} -p ${SUPERDIR}/${MY_MODULE}
popd
